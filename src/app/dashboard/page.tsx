...
export default function Dashboard() {
  ...
  const [, setIsCheckingWhatsApp] = useState(false);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (postingData) {
        // After successful creation, fetch the complete listing with images
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#1C1C1C] rounded-lg p-6 mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-grow">
                ...
                <div className="text-gray-400">
                  {whatsAppInfo.status === 'connected' ? (
                    <>
                      <p>Conectado y listo para usar</p>
                      <p className="text-sm mt-1">Número: {whatsAppInfo.phone}</p>
                    </>
                  ) : (
                    <>
                      <p>Verificación en progreso</p>
                      <p className="text-sm mt-1">Número: {whatsAppInfo.phone}</p>
                      <p className="text-xs mt-1 text-yellow-500">Nuestro equipo está trabajando en verificar tu número y asignarte uno nuevo</p>
                    </>
                  )}
                </div>
              </div>
              <div className="flex flex-col items-end gap-2">
                <button
                  onClick={() => window.open('https://wa.me/5491162065154', '_blank')}
          ...
          {/* Global Alert */}
          <div className="mt-4 p-4 bg-blue-900/30 border border-blue-500/50 rounded-lg flex items-start gap-3">
            <svg
            ...
            <div className="text-sm text-blue-200">
              ...
              <p>Mientras tu número está siendo verificado, todas las consultas serán atendidas por nuestro agente general. Una vez que se te asigne tu número personal, podrás gestionar tus propias consultas directamente.</p>
            </div>
          </div>
        </div>
        ...
        {/* Add Property Form */}
        <div className="bg-[#1C1C1C] rounded-lg p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">Agregar Nueva Propiedad</h2>
          <form onSubmit={handleSubmit}>
            ...
            >
              {loading ? 'Procesando...' : 'Agregar Propiedad'}
            </button>
        ...
        <div className="bg-[#1C1C1C] rounded-lg p-6">
          ...
          {loadingListings ? (
            ...
            <div className="text-center py-8 text-gray-400">
              No se encontraron propiedades. Agrega tu primera propiedad usando el formulario de arriba.
            </div>
          ) : (
        ...
        <Dialog open={showWhatsAppDialog} onOpenChange={setShowWhatsAppDialog}>
          <DialogContent className="bg-gray-900 text-white border border-gray-800">
            <DialogHeader>
              <DialogTitle>Verificación de WhatsApp</DialogTitle>
            </DialogHeader>
            <div className="p-6">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-1">Configuración de WhatsApp en Progreso</h3>
                  <p className="text-gray-400">
                    Nuestro equipo está trabajando en agregar tu número de WhatsApp al sistema.
                  </p>
                </div>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-4 text-sm text-gray-300">
                <p>Un miembro de nuestro equipo te contactará pronto para verificar y configurar tu integración de WhatsApp.</p>
                <p className="mt-2">Esto usualmente toma menos de 24 horas.</p>
              </div>
            </div>
          </DialogContent>
        </Dialog>
